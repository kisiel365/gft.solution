...
import com.google.common.collect.Sets;
 ...
 public class Scenario30 extends Scenario
 {
   ...
   public Set<OrderBook> orderBooks()
   {
     return Sets.newHashSet(new OrderBook[] {
       ...
       .buyEntry(OrderEntry.builder().id(1).amount(100).price(90).broker("1").client("112").build())
       .build(), 
       OrderBook.builder().product("B")
       .sellEntry(OrderEntry.builder().id(1).amount(200).price(110).broker("2").client("113").build())
       .buyEntry(OrderEntry.builder().id(1).amount(200).price(105).broker("2").client("109").build())
       .buyEntry(OrderEntry.builder().id(2).amount(200).price(100).broker("2").client("101").build())
       .buyEntry(OrderEntry.builder().id(3).amount(300).price(100).broker("2").client("105").build())
       .build(), 
       ...
       .sellEntry(OrderEntry.builder().id(3).amount(400).price(100).broker("1").client("106").build())
       ...
       .buyEntry(OrderEntry.builder().id(1).amount(400).price(105).broker("3").client("111").build())
       .buyEntry(OrderEntry.builder().id(2).amount(400).price(100).broker("3").client("103").build())
       .buyEntry(OrderEntry.builder().id(3).amount(500).price(100).broker("3").client("107").build())
       .build() });
   }
 }
