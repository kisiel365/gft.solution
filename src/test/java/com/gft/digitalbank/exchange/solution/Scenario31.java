...
import com.google.common.collect.Sets;
 ...
 public class Scenario31 extends Scenario
 {
   ...
   public Set<Transaction> transactions()
   {
     return Sets.newHashSet(new Transaction[] {
       Transaction.builder().id(1).amount(100).price(100).brokerBuy("4").brokerSell("1").clientBuy("104")
       ...
       Transaction.builder().id(1).amount(300).price(100).brokerBuy("2").brokerSell("3").clientBuy("106")
