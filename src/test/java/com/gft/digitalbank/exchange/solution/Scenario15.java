 ...
 public class Scenario15 extends Scenario
 {
   ...
   public Set<Transaction> transactions()
   {
     return Sets.newHashSet(new Transaction[] {
       ...
       Transaction.builder().id(2).amount(300).price(90).brokerBuy("3").brokerSell("1").clientBuy("103")
   ...
   public Set<OrderBook> orderBooks()
   {
     return Sets.newHashSet(new OrderBook[] {
       ...
       .buyEntry(OrderEntry.builder().id(1).amount(500).price(90).broker("3").client("103").build())
       .build() });
   }
 }
