...
import com.google.common.collect.Sets;
 ...
 public class Scenario28 extends Scenario
 {
   ...
   public Set<Transaction> transactions()
   {
     return Sets.newHashSet(new Transaction[] {
       ...
       Transaction.builder().id(2).amount(100).price(100).brokerBuy("2").brokerSell("1").clientBuy("101")
       .clientSell("102").product("A").build(), 
       Transaction.builder().id(3).amount(200).price(100).brokerBuy("3").brokerSell("1").clientBuy("103")
       .clientSell("102").product("A").build() });
   }
   ...
   public Set<OrderBook> orderBooks()
   {
     return Sets.newHashSet(new OrderBook[] {OrderBook.builder().product("A")
       .buyEntry(com.gft.digitalbank.exchange.model.OrderEntry.builder().id(1).amount(200).price(100).broker("3").client("103").build()).build() });
   }
 }
