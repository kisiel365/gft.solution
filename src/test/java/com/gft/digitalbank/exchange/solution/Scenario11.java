...
public class Scenario11 extends Scenario {
	...
	public Set<Transaction> transactions() {
		return Sets.newHashSet(new Transaction[] {
				...
				Transaction.builder().id(2).amount(100).price(90).brokerBuy("3").brokerSell("1").clientBuy("103")
	...
	public Set<OrderBook> orderBooks() {
		return Sets.newHashSet(new OrderBook[] {
				...
				OrderBook.builder().product("A")
						.sellEntry(OrderEntry.builder().id(1).amount(200).price(90).broker("1").client("102").build())
